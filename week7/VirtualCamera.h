...
public:
	...
	using BodyConstructionFunction = void(AVirtualCamera::*)();
	static const BodyConstructionFunction BodyConstructionFunctions[static_cast<int>(EBody::Transposer) + 1];

	using BodyFunction = void(AVirtualCamera::*)(float deltaTime);
	static const BodyFunction BodyFunctions[static_cast<int>(EBody::Transposer) + 1];

	using AimingFunction = void(AVirtualCamera::*)(float deltaTime);
	static const AimingFunction AimingFunctions[static_cast<int>(EAim::SameAsFollowTarget) + 1];
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "Aim", meta = (EditCondition = "Aim == EAim::GroupComposer", EditConditionHides))
		TArray<FTargetGroup> GroupTarget;
	...
	UPROPERTY(EditAnywhere, Category = "Aim", meta = (EditCondition = "Aim == EAim::POV", EditConditionHides, ClampMin = "0.0",ClampMax ="10.0"))
	...
	UPROPERTY(EditAnywhere, Category = "Aim", meta = (EditCondition = "Aim == EAim::POV", EditConditionHides, ClampMin = "-90.0", ClampMax = "90.0"))
	...
	UFUNCTION()
		void DoNothingConstruction() {};

	UFUNCTION()
		void ThirdPersonFollowConstruction();
	UFUNCTION()
		void FramingTransposerConstruction();
	UFUNCTION()
		void HardLockToTargetConstruction();
	UFUNCTION()
		void OrbitalTransposerConstruction();
	UFUNCTION()
		void TrackedDollyConstruction();
	UFUNCTION()
		void TransposerConstruction();

	UFUNCTION()
		void DoNothing(float deltaTime) {};

	UFUNCTION()
		void ThirdPersonFollowUpdate(float deltaTime);
	UFUNCTION()
		void FramingTransposerUpdate(float deltaTime);
	UFUNCTION()
		void HardLockToTargetUpdate(float deltaTime);
	UFUNCTION()
		void OrbitalTransposerUpdate(float deltaTime);
	UFUNCTION()
		void TrackedDollyUpdate(float deltaTime);
	UFUNCTION()
		void TransposerUpdate(float deltaTime);

	UFUNCTION()
		void ComposerUpdate(float deltaTime);
	UFUNCTION()
		void GroupComposerUpdate(float deltaTime);
	UFUNCTION()
		void HardLookAtUpdate(float deltaTime);
	UFUNCTION()
		void POVUpdate(float deltaTime);
	UFUNCTION()
		void SameAsFollowTargetUpdate(float deltaTime);
};